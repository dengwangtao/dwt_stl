...
TEST(equal_test)
{
  ...
  EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()),
            dwt_stl::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()));
}

TEST(fill_test)
{
  int exp[10], act[10];
  dwt_stl::vector<int> v1(10, 1);
  dwt_stl::vector<int> v2(10, 2);
...
TEST(lexicographical_compare_test)
{
  ...
  EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()),
            dwt_stl::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()));
  EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()),
            dwt_stl::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()));
}
...
TEST(mismatch_test)
{
  ...
  auto p6 = dwt_stl::mismatch(arr1, arr1 + 7, arr4, std::equal_to<int>());
...
TEST(make_heap_test)
{
  ...
  dwt_stl::make_heap(arr6, arr6 + 10, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
...
TEST(pop_heap_test)
{
  ...
  dwt_stl::pop_heap(arr4, arr4 + 9, std::greater<int>());
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(sort_heap_test)
{
  ...
  dwt_stl::sort_heap(arr4, arr4 + 9, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(set_difference_test)
{
  ...
  dwt_stl::set_difference(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(set_intersection_test)
{
  ...
  dwt_stl::set_intersection(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(set_symmetric_difference_test)
{
  ...
  dwt_stl::set_symmetric_difference(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(set_union_test)
{
  ...
  dwt_stl::set_union(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(accumulate_test)
{
  ...
  EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0, std::minus<int>()),
            dwt_stl::accumulate(arr1, arr1 + 5, 0, std::minus<int>()));
}
...
TEST(adjacent_difference_test)
{
  ...
  dwt_stl::adjacent_difference(arr2, arr2 + 5, act, std::minus<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(inner_product_test)
{
  ...
  EXPECT_EQ(std::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()),
            dwt_stl::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()));
}
...
TEST(partial_sum_test)
{
  ...
  dwt_stl::partial_sum(arr1, arr1 + 9, act2, std::multiplies<int>());
  EXPECT_CON_EQ(exp2, act2);
}
...
TEST(adjacent_find_test)
{
  ...
  EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5, std::greater<int>()),
            dwt_stl::adjacent_find(arr1, arr1 + 5, std::greater<int>()));
}
...
TEST(equal_range_test)
{
  ...
  auto p3 = dwt_stl::equal_range(arr1, arr1 + 7, 6, std::equal_to<int>());
...
TEST(find_end_test)
{
  ...
  EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()),
            dwt_stl::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()));
}
...
TEST(find_first_of_test)
{
  ...
  EXPECT_EQ(std::find_first_of(arr1, arr1 + 5, arr3, arr3 + 3, std::equal_to<int>()),
            dwt_stl::find_first_of(arr1, arr1 + 5, arr3, arr3 + 3, std::equal_to<int>()));
}
...
TEST(includes_test)
{
  ...
  EXPECT_EQ(std::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()),
            dwt_stl::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()));
}
...
TEST(inplace_merge_test)
{
  ...
  dwt_stl::inplace_merge(arr4, arr4 + 3, arr4 + 8, std::less<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(is_heap_test)
{
  ...
  EXPECT_EQ(std::is_heap(arr2, arr2 + 10, std::less<int>()),
            dwt_stl::is_heap(arr2, arr2 + 10, std::less<int>()));
...
TEST(is_sorted_test)
{
  ...
  EXPECT_EQ(std::is_sorted(arr3, arr3 + 5, std::less<int>()),
            dwt_stl::is_sorted(arr3, arr3 + 5, std::less<int>()));
  EXPECT_EQ(std::is_sorted(arr4, arr4 + 5, std::less<int>()),
            dwt_stl::is_sorted(arr4, arr4 + 5, std::less<int>()));
}
...
TEST(lower_bound_test)
{
  ...
  EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 5, std::less<int>()),
            dwt_stl::lower_bound(arr1, arr1 + 7, 5, std::less<int>()));
}
...
TEST(merge_test)
{
  ...
  dwt_stl::merge(arr3, arr3 + 5, arr4, arr4 + 5, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(is_permutation_test)
{
  ...
  EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr2, std::equal_to<int>()),
            dwt_stl::is_permutation(arr1, arr1 + 5, arr2, arr2 + 5, std::equal_to<int>()));
  EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr3, std::equal_to<int>()),
            dwt_stl::is_permutation(arr1, arr1 + 5, arr3, arr3 + 5, std::equal_to<int>()));
}
...
TEST(next_permutation_test)
{
  ...
  dwt_stl::next_permutation(arr2, arr2 + 4, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(nth_element_test)
{
  ...
  dwt_stl::nth_element(arr3, arr3 + 8, arr3 + 9, std::less<int>());
  dwt_stl::nth_element(arr4, arr4 + 3, arr4 + 16, std::less<int>());
...
TEST(partial_sort_test)
{
  ...
  dwt_stl::partial_sort(arr4, arr4 + 5, arr4 + 13, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(partial_sort_copy_test)
{
  ...
  dwt_stl::partial_sort_copy(arr3, arr3 + 15, act, act + 5, std::greater<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(prev_permutation_test)
{
  ...
  dwt_stl::prev_permutation(arr2, arr2 + 4, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(search_test)
{
  ...
  EXPECT_EQ(std::search(arr1, arr1 + 9, arr4, arr4 + 3, std::less<int>()),
            dwt_stl::search(arr1, arr1 + 9, arr4, arr4 + 3, std::less<int>()));
  EXPECT_EQ(std::search(arr1, arr1 + 9, arr4, arr4 + 4, std::less<int>()),
            dwt_stl::search(arr1, arr1 + 9, arr4, arr4 + 4, std::less<int>()));
}
...
TEST(search_n_test)
{
  ...
  EXPECT_EQ(std::search_n(arr1, arr1 + 9, 3, 6, std::less<int>()),
            dwt_stl::search_n(arr1, arr1 + 9, 3, 6, std::less<int>()));
  EXPECT_EQ(std::search_n(arr1, arr1 + 9, 2, 10, std::less<int>()),
            dwt_stl::search_n(arr1, arr1 + 9, 2, 10, std::less<int>()));
}
...
TEST(sort_test)
{
  ...
  dwt_stl::sort(arr6, arr6 + 9, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
  EXPECT_CON_EQ(arr5, arr6);
}
...
TEST(unique_copy_test)
{
  ...
  dwt_stl::unique_copy(arr2, arr2 + 9, act, std::equal_to<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(upper_bound_test)
{
  ...
  EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 6, std::less<int>()),
            dwt_stl::upper_bound(arr1, arr1 + 9, 6, std::less<int>()));
  EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 7, std::less<int>()),
            dwt_stl::upper_bound(arr1, arr1 + 9, 7, std::less<int>()));
}
