...
template <class T, class Container = dwt_stl::vector<T>, class Compare = dwt_stl::less<typename Container::value_type>>
class priority_queue
{
    ...
    public:
        ...
        void swap(priority_queue& rhs) noexcept(noexcept(dwt_stl::swap(c_, rhs.c_)) && noexcept(dwt_stl::swap(comp_, rhs.comp_)))
        {
            dwt_stl::swap(c_, rhs.c_);
